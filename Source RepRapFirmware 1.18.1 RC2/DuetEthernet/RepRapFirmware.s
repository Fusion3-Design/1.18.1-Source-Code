ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 1
  ...
  14              		.thumb
  15              		.file	"RepRapFirmware.cpp"
  16              		.section	.text.debugPrintf,"ax",%progbits
  17              		.align	2
  18              		.global	debugPrintf
  19              		.thumb
  20              		.thumb_func
  21              		.type	debugPrintf, %function
  22              	debugPrintf:
  23              		@ args = 4, pretend = 16, frame = 8
  24              		@ frame_needed = 0, uses_anonymous_args = 1
  25 0000 0FB4     		push	{r0, r1, r2, r3}
  26 0002 00B5     		push	{lr}
  27 0004 83B0     		sub	sp, sp, #12
  28 0006 04AB     		add	r3, sp, #16
  29 0008 0649     		ldr	r1, .L2
  30 000a 53F8042B 		ldr	r2, [r3], #4
  31 000e 0868     		ldr	r0, [r1]
  32 0010 0193     		str	r3, [sp, #4]
  33 0012 0321     		movs	r1, #3
  34 0014 FFF7FEFF 		bl	_ZN8Platform8MessageFE11MessageTypePKcSt9__va_list
  35 0018 03B0     		add	sp, sp, #12
  36              		@ sp needed
  37 001a 5DF804EB 		ldr	lr, [sp], #4
  38 001e 04B0     		add	sp, sp, #16
  39 0020 7047     		bx	lr
  40              	.L3:
...
ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 2
 ...
 114              	.L19:
ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 3
...
ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 4
 ...
 217 0012 1360     		str	r3, [r2]
 218 0014 5060     		str	r0, [r2, #4]
 ...
 228              		.align	2
ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 5
...
ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 6
...
ARM GAS  C:\Users\tstern\AppData\Local\Temp\cclQlQSl.s 			page 7
