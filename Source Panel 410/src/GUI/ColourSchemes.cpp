...
{
	//Fusion 3 color scheme
	{
		.index = 0,
		.pal = IconPaletteLight,

		.titleBarTextColour = orange,
		.titleBarBackColour = black,
		.labelTextColour = white,
		.infoTextColour = white,
		.infoBackColour = slate,
		.defaultBackColour = slate,
